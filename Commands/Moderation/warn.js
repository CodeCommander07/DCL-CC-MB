...
module.exports = {
  ...
  data: new SlashCommandBuilder()
    .setName("warn")
    .setDescription(
      "Warn users who do not behave according to our community rules."
    )
      ...
      case "add":
        warningSchema.findOne(
          ...
          async (err, data) => {
            ...
            const dataInf = await infrSchema.findOne({
            ...
            if (!dataInf) {
              ...
              const newPoints = (dataInf.Points += 1);
              await dataInf.updateOne({
                Guild: interaction.guild.id,
                UserID: user.id,
                Points: newPoints,
              });
            ...
            if (Object.keys(data.Content).length == 3) {
              try {
                if (
                  ...
                  embed
                    .setColor("Blue")
                    .setDescription(
                      `I would normally kick ${target} because he reached 3 warns, but he's higher than me :(`
                    )
                    .setFooter({
                      text: target.tag,
              ...
              interaction.reply({
                content: `Make sure you read our <#1101146309387358340>`,
                embeds: [embed],
              });
            }
          }
